...
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "Market Cap", value: "$17.6Bn", percentageChange: 27.55)
    let stat2 = StatisticModel(title: "Market Cap", value: "$1.7Tr")
    let stat3 = StatisticModel(title: "Market Cap", value: "$17.6Bn", percentageChange: -27.55)
